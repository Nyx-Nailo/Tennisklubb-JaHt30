    ...
    return (
        <>
            ...
            <form action="index.html">
                <div>
                    <input type="checkbox" id="men" value="Herrarnas" name="omkl" />
                    <label for="men">Herrarnas</label>
                    <input type="checkbox" id="women" value="Damernas" name="omkl" />
                    <label for="women">Damernas</label>
                </div>
                <div>
                ...
                <div>
                    <label for="name">Datum och tid:</label>
                    <input type="datetime-local" id="date" name="time" required />
                </div>
